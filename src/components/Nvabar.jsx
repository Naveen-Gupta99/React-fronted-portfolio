  ...
  return (
    ...
    <div>
      <nav>
        ...
        <svg onClick={() => window.open('https://www.linkedin.com/in/naveen-kr-gupta-510190336/', "_blank")} className="linkedIn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 112.196 112.196" id="linkedin">
